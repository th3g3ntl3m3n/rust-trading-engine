...
impl Orderbook {
    ...
    pub fn fill_market_order(&mut self, market_order: &mut Order) {
        ...
        for lim_order in limits {
            lim_order.fill_order(market_order)
        }
    }
...
pub mod tests {
    ...
    fn orderbook_fill_market_order_ask() {
        ...
        orderbook.add_order(dec!(87), Order::new(BidOrAsk::Ask, 10.0));
        orderbook.add_order(dec!(7), Order::new(BidOrAsk::Ask, 10.0));
        orderbook.add_order(dec!(187), Order::new(BidOrAsk::Ask, 10.0));
        orderbook.add_order(dec!(8), Order::new(BidOrAsk::Ask, 10.0));
        orderbook.add_order(dec!(54), Order::new(BidOrAsk::Ask, 10.0));
